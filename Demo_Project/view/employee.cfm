			...
			<div class="row">
				...
				<div class="col-sm-9">
					<div class="tab-content">
						...
						<!--/tab-pane-->
					<cfset employeeDetails=application.employeeDao.getEmployeeProjectDetails()>
					<cfif employeeDetails.ProjectID NEQ "">
						<cfset teamMember=application.employeeDao.getEmployeeOnProjectById(employeeDetails.ProjectID)>
						<div class="tab-pane" id="Project">
							<span><strong>Works with:</strong> <cfoutput>#employeeDetails.TeamLeaderName#</cfoutput></span>

							<hr>

							<h4>Project Name: <h5><cfoutput>#employeeDetails.Title#</cfoutput></h5>
							</h4>

							<h5><strong>Project Descreption:</strong> <h6><cfoutput>#employeeDetails.Descreption#</cfoutput></h6>
							</h5>

							<h4><strong>Team Members:</strong>
							</h4>
							<cfoutput query="teamMember">
								<span>#EMPLOYEENAME#</span><br>
							</cfoutput>
						</div>
					<cfelse>
						<div class="tab-pane" id="Project">
							<span><strong>Works with:</strong> Not in any project assignment now.</span>
							...
							<h5><strong>Project Descreption:</h6>
							</h5>
