	...
	<html>
		...
		<body>
			...
			<div class="" style="margin: 10px">
						...
						<tbody>
							<cfoutput query="employeeDetails">
								...
								<cfelse>
									...
									<td>#UserType#</td>
									<cfif Title NEQ "">
										<td style="cursor: pointer;" onClick=showProjectDetails("#Title#","#Descreption#")>#Title#</td>	
									<cfelse>
										<cfif ActiveStatus EQ 1>
											<td style="cursor: pointer;" onClick=addOnProject("#EmployeeID#")>NA</td>
										<cfelse>
											<td>NA</td> 
										</cfif>
						...
						<tbody>
							...
							<cfelse>
								<tr class="danger">
									...
									<cfif ActiveStatus EQ 1>
										<td>#ProjectID#</td>
										<td   style="cursor: pointer;" onClick="showEmployeeOnProject(#ProjectID#);">#Title#</td>
										<td>#Descreption#</td>
										<td>#TeamLeader#</td>
										<td><p class="">Yes</p></td>
				...
				<cfinclude template="showEmployeeOnProject.cfm">
				<cfinclude template="showProjectDetails.cfm">
				<cfinclude template="addOnProject.cfm">
